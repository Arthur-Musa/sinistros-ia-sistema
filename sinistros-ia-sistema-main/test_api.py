...
def test_analyze_sinistro(numero_sinistro):
    """Testa análise de sinistro"""
    print(f"🤖 Iniciando análise do sinistro {numero_sinistro}...")
    ...
    # Aguardar análise
    import time
    print("⏱️  Aguardando conclusão da análise...")
    time.sleep(3)
    
    # Verificar status
    print(f"📊 Verificando status da análise...")
...
if __name__ == "__main__":
    print("🚀 Iniciando testes da API de Sinistros")
    print("=" * 50)
